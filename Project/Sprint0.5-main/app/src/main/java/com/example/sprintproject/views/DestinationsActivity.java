...
public class DestinationsActivity extends AppCompatActivity {
    ...
    private void setupBottomNavigation() {
        ...
        findViewById(R.id.icon_dining).setOnClickListener(v -> {
            Intent intent = new Intent(DestinationsActivity.this, DiningEstablishmentsActivity.class);
            startActivity(intent);
            finish();
        });
        ...
        findViewById(R.id.icon_travel_community).setOnClickListener(v -> {
            Intent intent = new Intent(DestinationsActivity.this, TravelCommunityActivity.class);
            startActivity(intent);
            finish();
        });
    }
