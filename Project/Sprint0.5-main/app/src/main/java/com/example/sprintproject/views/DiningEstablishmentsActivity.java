    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logisticsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(DiningEstablishmentsActivity.this, LogisticsActivity.class));
            }
        });
        ...
        destinationsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DiningEstablishmentsActivity.this, DestinationsActivity.class));
            }
        });
        ...
        diningButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DiningEstablishmentsActivity.this, DiningEstablishmentsActivity.class));
            }
        });
        ...
        accommodationsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DiningEstablishmentsActivity.this, AccommodationsActivity.class));
            }
        });
        ...
        communityButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DiningEstablishmentsActivity.this, TravelCommunityActivity.class));
            }
        });
    }
